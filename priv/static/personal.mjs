...
function view(props) {
  return nav(
    ...
    toList([
      div(
        ...
        toList([
          div(
            toList([
              class$(
                "w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 text-gray-800 shadow-neu-inner dark:text-gray-100 dark:shadow-dark-neu-inner"
              )
            ]),
            toList([
              span(
      ...
      div(
        toList([class$("items-center justify-center flex")]),
        toList([
          button(toList([]), toList([text("Sobre")])),
          button(toList([]), toList([text("Log")])),
          label(
            toList([
            ...
            toList([
              div(
                toList([
                  class$(
                    "bg-gradient-to-br from-bg-gray-800 to-gray-900relative h-[30px] w-[60px] rounded-full overflow-hidden shadow-neu-switch dark:shadow-dark-neu-switch"
                  )
                ]),
                toList([
                  input(
                    ...
                    toList([
                      (() => {
                        ...
                        if ($) {
                          return moon(
                            toList([
                              class$("inline text-gray-200 p-1")
                            ])
                          );
                        } else {
                          return sun(
                            toList([
                              class$("inline text-gray-800 p-1")
                            ])
                          );
                        }
                      })()
      ...
      class$(
        (() => {
          ...
          if ($) {
            ...
            return "light bg-gray-200 bg-gradient-to-br from-bg-gray-100 to-gray-200";
          }
