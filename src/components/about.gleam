        ...
        html.button(
          [
            attribute.class(
              ...
              <> "text-gray-800 bg-gray-200 shadow-neu "
              <> "hover:bg-[#292d3e] hover:text-[#ffaff3] hover:shadow-[inset_4px_4px_6px_rgba(255,175,243,0.15),inset_-4px_-4px_6px_rgba(255,175,243,0.75)] ",
            ),
          ],
          [
            icon.star_filled([attribute.class("w-5 mr-1")]),
            element.text("Gleam"),
          ],
        ),
      ]),
