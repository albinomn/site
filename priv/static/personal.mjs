...
function view(props) {
  let nav_shadow_classes = (() => {
    let $ = props.dark;
    if ($) {
      return "shadow-[4px_4px_6px_rgba(0,0,0,0.4),-4px_-4px_6px_rgba(255,255,255,0.1)]";
    } else {
      return "shadow-[4px_4px_6px_rgba(0,0,0,0.1),-4px_-4px_6px_rgba(255,255,255,0.7)]";
    }
  })();
  let logo_classes = (() => {
    let $ = props.dark;
    if ($) {
      return "bg-gray-700 text-white shadow-[inset_2px_2px_4px_rgba(0,0,0,0.4),inset_-2px_-2px_4px_rgba(255,255,255,0.1)]";
    } else {
      return "bg-gray-200 text-gray-800 shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.7)]";
    }
  })();
  let button_classes = (() => {
    let $ = props.dark;
    if ($) {
      return "bg-gray-800 text-white hover:bg-gray-700 shadow-[4px_4px_6px_rgba(0,0,0,0.4),-4px_-4px_6px_rgba(255,255,255,0.1)] active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.4),inset_-2px_-2px_4px_rgba(255,255,255,0.1)]";
    } else {
      return "bg-gray-100 text-gray-800 hover:bg-gray-200 shadow-[4px_4px_6px_rgba(0,0,0,0.1),-4px_-4px_6px_rgba(255,255,255,0.7)] active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.7)]";
    }
  })();
  let link_classes = (() => {
    let $ = props.dark;
  ...
  return nav(
    toList([
      class$(
        nav_shadow_classes + " w-full rounded-xl p-4 transition-all duration-300"
      )
    ]),
    toList([
      div(
        toList([class$("max-w-7xl mx-auto px-4")]),
        toList([
          div(
...
function view2(model) {
  ...
  return div(
    toList([
      class$(
        (() => {
          let $ = model.dark_mode;
          if ($) {
            return "dark bg-gray-800 bg-gradient-to-br from-bg-gray-800 to-gray-900";
          } else {
            return "light bg-gray-100 bg-gradient-to-br from-bg-gray-100 to-gray-200";
          }
    ...
    toList([
      div(
        toList([class$("max-w-[1080px] mx-auto w-full ")]),
        toList([view(navbar_props)])
      )
    ])
  );
}
function main() {
  let app = simple(init2, update, view2);
